 ...
 *                     &lt;/complexType&gt;
 *                   &lt;/element&gt;
 *                   &lt;element name="SegGrp-8" maxOccurs="2" minOccurs="0"&gt;
 *                     &lt;complexType&gt;
 *                       &lt;complexContent&gt;
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                           &lt;sequence&gt;
...
public class AUTHOR {
    ...
    protected List<AUTHOR.SegGrp1> segGrp1;
    @XmlElement(name = "SegGrp-2")
    protected List<AUTHOR.SegGrp2> segGrp2;
    @XmlElement(name = "SegGrp-3")
    protected List<AUTHOR.SegGrp3> segGrp3;
    @XmlElement(name = "SegGrp-4", required = true)
    protected List<AUTHOR.SegGrp4> segGrp4;
    @XmlElement(name = "CNT")
    protected List<CNTControlTotal> cnt;
    @XmlElement(name = "SegGrp-9")
    protected List<AUTHOR.SegGrp9> segGrp9;
     ...
     * 
     */
    public List<AUTHOR.SegGrp1> getSegGrp1() {
        if (segGrp1 == null) {
            segGrp1 = new ArrayList<AUTHOR.SegGrp1>();
        }
        return this.segGrp1;
    }
     ...
     * 
     */
    public List<AUTHOR.SegGrp2> getSegGrp2() {
        if (segGrp2 == null) {
            segGrp2 = new ArrayList<AUTHOR.SegGrp2>();
        }
        return this.segGrp2;
    }
     ...
     * 
     */
    public List<AUTHOR.SegGrp3> getSegGrp3() {
        if (segGrp3 == null) {
            segGrp3 = new ArrayList<AUTHOR.SegGrp3>();
        }
        return this.segGrp3;
    }
     ...
     * 
     */
    public List<AUTHOR.SegGrp4> getSegGrp4() {
        if (segGrp4 == null) {
            segGrp4 = new ArrayList<AUTHOR.SegGrp4>();
        }
        return this.segGrp4;
    }
     ...
     * 
     */
    public List<AUTHOR.SegGrp9> getSegGrp9() {
        if (segGrp9 == null) {
            segGrp9 = new ArrayList<AUTHOR.SegGrp9>();
        }
        return this.segGrp9;
    }

    public AUTHOR withBGM(BGMBeginningOfMessage value) {
        setBGM(value);
        return this;
    }

    public AUTHOR withDTM(DTMDateTimePeriod value) {
        setDTM(value);
        return this;
    }

    public AUTHOR withBUS(BUSBusinessFunction value) {
        setBUS(value);
        return this;
    }

    public AUTHOR withSegGrp1(AUTHOR.SegGrp1 ... values) {
        if (values!= null) {
            for (AUTHOR.SegGrp1 value: values) {
    ...
    public AUTHOR withSegGrp1(Collection<AUTHOR.SegGrp1> values) {
        if (values!= null) {
    ...
    public AUTHOR withSegGrp2(AUTHOR.SegGrp2 ... values) {
        if (values!= null) {
            for (AUTHOR.SegGrp2 value: values) {
    ...
    public AUTHOR withSegGrp2(Collection<AUTHOR.SegGrp2> values) {
        if (values!= null) {
    ...
    public AUTHOR withSegGrp3(AUTHOR.SegGrp3 ... values) {
        if (values!= null) {
            for (AUTHOR.SegGrp3 value: values) {
    ...
    public AUTHOR withSegGrp3(Collection<AUTHOR.SegGrp3> values) {
        if (values!= null) {
    ...
    public AUTHOR withSegGrp4(AUTHOR.SegGrp4 ... values) {
        if (values!= null) {
            for (AUTHOR.SegGrp4 value: values) {
    ...
    public AUTHOR withSegGrp4(Collection<AUTHOR.SegGrp4> values) {
        if (values!= null) {
    ...
    public AUTHOR withCNT(CNTControlTotal... values) {
        if (values!= null) {
    ...
    public AUTHOR withCNT(Collection<CNTControlTotal> values) {
        if (values!= null) {
    ...
    public AUTHOR withSegGrp9(AUTHOR.SegGrp9 ... values) {
        if (values!= null) {
            for (AUTHOR.SegGrp9 value: values) {
    ...
    public AUTHOR withSegGrp9(Collection<AUTHOR.SegGrp9> values) {
        if (values!= null) {
    ...
    public static class SegGrp1 {
        ...
        public AUTHOR.SegGrp1 withRFF(RFFReference value) {
            setRFF(value);
            return this;
        }

        public AUTHOR.SegGrp1 withDTM(DTMDateTimePeriod value) {
            setDTM(value);
            return this;
        }
    ...
    public static class SegGrp2 {
        ...
        public AUTHOR.SegGrp2 withFII(FIIFinancialInstitutionInformation value) {
            setFII(value);
            return this;
        }

        public AUTHOR.SegGrp2 withCTA(CTAContactInformation value) {
            setCTA(value);
            return this;
        }

        public AUTHOR.SegGrp2 withCOM(COMCommunicationContact... values) {
            if (values!= null) {
        ...
        public AUTHOR.SegGrp2 withCOM(Collection<COMCommunicationContact> values) {
            if (values!= null) {
    ...
    public static class SegGrp3 {
        ...
        public AUTHOR.SegGrp3 withNAD(NADNameAndAddress value) {
            setNAD(value);
            return this;
        }

        public AUTHOR.SegGrp3 withCTA(CTAContactInformation value) {
            setCTA(value);
            return this;
        }

        public AUTHOR.SegGrp3 withCOM(COMCommunicationContact... values) {
            if (values!= null) {
                for (COMCommunicationContact value: values) {
                    getCOM().add(value);
                }
        ...
        public AUTHOR.SegGrp3 withCOM(Collection<COMCommunicationContact> values) {
            if (values!= null) {
                getCOM().addAll(values);
            }
            return this;
    ...
    public static class SegGrp4 {
        ...
        protected List<AUTHOR.SegGrp4 .SegGrp5> segGrp5;
        @XmlElement(name = "SegGrp-6")
        protected List<AUTHOR.SegGrp4 .SegGrp6> segGrp6;
        @XmlElement(name = "SegGrp-7")
        protected List<AUTHOR.SegGrp4 .SegGrp7> segGrp7;
        @XmlElement(name = "SegGrp-8")
        protected List<AUTHOR.SegGrp4 .SegGrp8> segGrp8;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link AUTHOR.SegGrp4 .SegGrp5 }
         * 
         * 
         */
        public List<AUTHOR.SegGrp4 .SegGrp5> getSegGrp5() {
            if (segGrp5 == null) {
                segGrp5 = new ArrayList<AUTHOR.SegGrp4 .SegGrp5>();
            }
            return this.segGrp5;
        }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link AUTHOR.SegGrp4 .SegGrp6 }
         * 
         * 
         */
        public List<AUTHOR.SegGrp4 .SegGrp6> getSegGrp6() {
            if (segGrp6 == null) {
                segGrp6 = new ArrayList<AUTHOR.SegGrp4 .SegGrp6>();
            }
            return this.segGrp6;
        }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link AUTHOR.SegGrp4 .SegGrp7 }
         * 
         * 
         */
        public List<AUTHOR.SegGrp4 .SegGrp7> getSegGrp7() {
            if (segGrp7 == null) {
                segGrp7 = new ArrayList<AUTHOR.SegGrp4 .SegGrp7>();
            }
            return this.segGrp7;
        }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link AUTHOR.SegGrp4 .SegGrp8 }
         * 
         * 
         */
        public List<AUTHOR.SegGrp4 .SegGrp8> getSegGrp8() {
            if (segGrp8 == null) {
                segGrp8 = new ArrayList<AUTHOR.SegGrp4 .SegGrp8>();
            }
            return this.segGrp8;
        }

        public AUTHOR.SegGrp4 withLIN(LINLineItem value) {
            setLIN(value);
            return this;
        }

        public AUTHOR.SegGrp4 withSegGrp5(AUTHOR.SegGrp4 .SegGrp5 ... values) {
            if (values!= null) {
                for (AUTHOR.SegGrp4 .SegGrp5 value: values) {
        ...
        public AUTHOR.SegGrp4 withSegGrp5(Collection<AUTHOR.SegGrp4 .SegGrp5> values) {
            if (values!= null) {
        ...
        public AUTHOR.SegGrp4 withSegGrp6(AUTHOR.SegGrp4 .SegGrp6 ... values) {
            if (values!= null) {
                for (AUTHOR.SegGrp4 .SegGrp6 value: values) {
        ...
        public AUTHOR.SegGrp4 withSegGrp6(Collection<AUTHOR.SegGrp4 .SegGrp6> values) {
            if (values!= null) {
        ...
        public AUTHOR.SegGrp4 withSegGrp7(AUTHOR.SegGrp4 .SegGrp7 ... values) {
            if (values!= null) {
                for (AUTHOR.SegGrp4 .SegGrp7 value: values) {
        ...
        public AUTHOR.SegGrp4 withSegGrp7(Collection<AUTHOR.SegGrp4 .SegGrp7> values) {
            if (values!= null) {
        ...
        public AUTHOR.SegGrp4 withSegGrp8(AUTHOR.SegGrp4 .SegGrp8 ... values) {
            if (values!= null) {
                for (AUTHOR.SegGrp4 .SegGrp8 value: values) {
        ...
        public AUTHOR.SegGrp4 withSegGrp8(Collection<AUTHOR.SegGrp4 .SegGrp8> values) {
            if (values!= null) {
        ...
        public static class SegGrp5 {
            ...
            public AUTHOR.SegGrp4 .SegGrp5 withRFF(RFFReference value) {
                setRFF(value);
                return this;
            }

            public AUTHOR.SegGrp4 .SegGrp5 withDTM(DTMDateTimePeriod value) {
                setDTM(value);
                return this;
            }
        ...
        public static class SegGrp6 {
            ...
            public AUTHOR.SegGrp4 .SegGrp6 withSEQ(SEQSequenceDetails value) {
                setSEQ(value);
                return this;
            }

            public AUTHOR.SegGrp4 .SegGrp6 withGIS(GISGeneralIndicator value) {
                setGIS(value);
                return this;
            }

            public AUTHOR.SegGrp4 .SegGrp6 withDTM(DTMDateTimePeriod... values) {
                if (values!= null) {
            ...
            public AUTHOR.SegGrp4 .SegGrp6 withDTM(Collection<DTMDateTimePeriod> values) {
                if (values!= null) {
            ...
            public AUTHOR.SegGrp4 .SegGrp6 withMOA(MOAMonetaryAmount value) {
                setMOA(value);
                return this;
            }

            public AUTHOR.SegGrp4 .SegGrp6 withDOC(DOCDocumentMessageDetails... values) {
                if (values!= null) {
            ...
            public AUTHOR.SegGrp4 .SegGrp6 withDOC(Collection<DOCDocumentMessageDetails> values) {
                if (values!= null) {
        ...
        public static class SegGrp7 {
            ...
            public AUTHOR.SegGrp4 .SegGrp7 withFII(FIIFinancialInstitutionInformation value) {
                setFII(value);
                return this;
            }

            public AUTHOR.SegGrp4 .SegGrp7 withCTA(CTAContactInformation value) {
                setCTA(value);
                return this;
            }

            public AUTHOR.SegGrp4 .SegGrp7 withCOM(COMCommunicationContact... values) {
                if (values!= null) {
                    for (COMCommunicationContact value: values) {
                        getCOM().add(value);
                    }
            ...
            public AUTHOR.SegGrp4 .SegGrp7 withCOM(Collection<COMCommunicationContact> values) {
                if (values!= null) {
                    getCOM().addAll(values);
                }
                return this;
        ...
        public static class SegGrp8 {
            ...
            public AUTHOR.SegGrp4 .SegGrp8 withNAD(NADNameAndAddress value) {
                setNAD(value);
                return this;
            }

            public AUTHOR.SegGrp4 .SegGrp8 withCTA(CTAContactInformation value) {
                setCTA(value);
                return this;
            }

            public AUTHOR.SegGrp4 .SegGrp8 withCOM(COMCommunicationContact... values) {
                if (values!= null) {
                    for (COMCommunicationContact value: values) {
                        getCOM().add(value);
                    }
            ...
            public AUTHOR.SegGrp4 .SegGrp8 withCOM(Collection<COMCommunicationContact> values) {
                if (values!= null) {
                    getCOM().addAll(values);
                }
                return this;
    ...
    public static class SegGrp9 {
        ...
        public AUTHOR.SegGrp9 withAUT(AUTAuthenticationResult value) {
            setAUT(value);
            return this;
        }

        public AUTHOR.SegGrp9 withDTM(DTMDateTimePeriod value) {
            setDTM(value);
            return this;
        }
