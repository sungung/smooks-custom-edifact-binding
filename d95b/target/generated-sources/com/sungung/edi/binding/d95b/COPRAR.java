...
/**
 * <p>Java class for COPRAR complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="COPRAR"&gt;
 *   &lt;complexContent&gt;
...
public class COPRAR {
    ...
    protected COPRAR.SegGrp1 segGrp1;
    @XmlElement(name = "SegGrp-2", required = true)
    protected List<COPRAR.SegGrp2> segGrp2;
    @XmlElement(name = "SegGrp-3", required = true)
    protected List<COPRAR.SegGrp3> segGrp3;
     ...
     *     
     */
    public COPRAR.SegGrp1 getSegGrp1() {
        return segGrp1;
    }
     ...
     *     
     */
    public void setSegGrp1(COPRAR.SegGrp1 value) {
        this.segGrp1 = value;
    }
     ...
     * 
     */
    public List<COPRAR.SegGrp2> getSegGrp2() {
        if (segGrp2 == null) {
            segGrp2 = new ArrayList<COPRAR.SegGrp2>();
        }
        return this.segGrp2;
    }
     ...
     * 
     */
    public List<COPRAR.SegGrp3> getSegGrp3() {
        if (segGrp3 == null) {
            segGrp3 = new ArrayList<COPRAR.SegGrp3>();
        }
        return this.segGrp3;
    }
    ...
    public COPRAR withBGM(BGMBeginningOfMessage value) {
        setBGM(value);
        return this;
    }

    public COPRAR withFTX(FTXFreeText... values) {
        if (values!= null) {
    ...
    public COPRAR withFTX(Collection<FTXFreeText> values) {
        if (values!= null) {
    ...
    public COPRAR withRFF(RFFReference... values) {
        if (values!= null) {
    ...
    public COPRAR withRFF(Collection<RFFReference> values) {
        if (values!= null) {
    ...
    public COPRAR withSegGrp1(COPRAR.SegGrp1 value) {
        setSegGrp1(value);
        return this;
    }

    public COPRAR withSegGrp2(COPRAR.SegGrp2 ... values) {
        if (values!= null) {
            for (COPRAR.SegGrp2 value: values) {
    ...
    public COPRAR withSegGrp2(Collection<COPRAR.SegGrp2> values) {
        if (values!= null) {
    ...
    public COPRAR withSegGrp3(COPRAR.SegGrp3 ... values) {
        if (values!= null) {
            for (COPRAR.SegGrp3 value: values) {
    ...
    public COPRAR withSegGrp3(Collection<COPRAR.SegGrp3> values) {
        if (values!= null) {
    ...
    public COPRAR withCNT(CNTControlTotal value) {
        setCNT(value);
        return this;
    }
    ...
    public static class SegGrp1 {
        ...
        public COPRAR.SegGrp1 withTDT(TDTDetailsOfTransport value) {
            setTDT(value);
            return this;
        }

        public COPRAR.SegGrp1 withRFF(RFFReference... values) {
            if (values!= null) {
                for (RFFReference value: values) {
                    getRFF().add(value);
                }
        ...
        public COPRAR.SegGrp1 withRFF(Collection<RFFReference> values) {
            if (values!= null) {
                getRFF().addAll(values);
            }
            return this;
        ...
        public COPRAR.SegGrp1 withLOC(LOCPlaceLocationIdentification... values) {
            if (values!= null) {
        ...
        public COPRAR.SegGrp1 withLOC(Collection<LOCPlaceLocationIdentification> values) {
            if (values!= null) {
        ...
        public COPRAR.SegGrp1 withDTM(DTMDateTimePeriod... values) {
            if (values!= null) {
        ...
        public COPRAR.SegGrp1 withDTM(Collection<DTMDateTimePeriod> values) {
            if (values!= null) {
        ...
        public COPRAR.SegGrp1 withFTX(FTXFreeText... values) {
            if (values!= null) {
                for (FTXFreeText value: values) {
                    getFTX().add(value);
                }
        ...
        public COPRAR.SegGrp1 withFTX(Collection<FTXFreeText> values) {
            if (values!= null) {
                getFTX().addAll(values);
            }
            return this;
    ...
    public static class SegGrp2 {
        ...
        public COPRAR.SegGrp2 withNAD(NADNameAndAddress value) {
            setNAD(value);
            return this;
        }

        public COPRAR.SegGrp2 withCTA(CTAContactInformation... values) {
            if (values!= null) {
        ...
        public COPRAR.SegGrp2 withCTA(Collection<CTAContactInformation> values) {
            if (values!= null) {
    ...
    public static class SegGrp3 {
        ...
        protected COPRAR.SegGrp3 .SegGrp4 segGrp4;
        @XmlElement(name = "NAD")
        protected NADNameAndAddress nad;
         ...
         * @return
         *     possible object is
         *     {@link COPRAR.SegGrp3 .SegGrp4 }
         *     
         */
        public COPRAR.SegGrp3 .SegGrp4 getSegGrp4() {
            return segGrp4;
        }
         ...
         *     
         */
        public void setSegGrp4(COPRAR.SegGrp3 .SegGrp4 value) {
            this.segGrp4 = value;
        }
        ...
        public COPRAR.SegGrp3 withEQD(EQDEquipmentDetails value) {
            setEQD(value);
            return this;
        }

        public COPRAR.SegGrp3 withRFF(RFFReference... values) {
            if (values!= null) {
                for (RFFReference value: values) {
                    getRFF().add(value);
                }
        ...
        public COPRAR.SegGrp3 withRFF(Collection<RFFReference> values) {
            if (values!= null) {
                getRFF().addAll(values);
            }
            return this;
        ...
        public COPRAR.SegGrp3 withEQN(EQNNumberOfUnits value) {
            setEQN(value);
            return this;
        }

        public COPRAR.SegGrp3 withTMD(TMDTransportMovementDetails... values) {
            if (values!= null) {
        ...
        public COPRAR.SegGrp3 withTMD(Collection<TMDTransportMovementDetails> values) {
            if (values!= null) {
        ...
        public COPRAR.SegGrp3 withDTM(DTMDateTimePeriod... values) {
            if (values!= null) {
                for (DTMDateTimePeriod value: values) {
                    getDTM().add(value);
                }
        ...
        public COPRAR.SegGrp3 withDTM(Collection<DTMDateTimePeriod> values) {
            if (values!= null) {
                getDTM().addAll(values);
            }
            return this;
        ...
        public COPRAR.SegGrp3 withLOC(LOCPlaceLocationIdentification... values) {
            if (values!= null) {
                for (LOCPlaceLocationIdentification value: values) {
                    getLOC().add(value);
                }
        ...
        public COPRAR.SegGrp3 withLOC(Collection<LOCPlaceLocationIdentification> values) {
            if (values!= null) {
                getLOC().addAll(values);
            }
            return this;
        ...
        public COPRAR.SegGrp3 withMEA(MEAMeasurements... values) {
            if (values!= null) {
        ...
        public COPRAR.SegGrp3 withMEA(Collection<MEAMeasurements> values) {
            if (values!= null) {
        ...
        public COPRAR.SegGrp3 withDIM(DIMDimensions... values) {
            if (values!= null) {
        ...
        public COPRAR.SegGrp3 withDIM(Collection<DIMDimensions> values) {
            if (values!= null) {
        ...
        public COPRAR.SegGrp3 withTMP(TMPTemperature... values) {
            if (values!= null) {
        ...
        public COPRAR.SegGrp3 withTMP(Collection<TMPTemperature> values) {
            if (values!= null) {
        ...
        public COPRAR.SegGrp3 withRNG(RNGRangeDetails... values) {
            if (values!= null) {
        ...
        public COPRAR.SegGrp3 withRNG(Collection<RNGRangeDetails> values) {
            if (values!= null) {
        ...
        public COPRAR.SegGrp3 withSEL(SELSealNumber... values) {
            if (values!= null) {
        ...
        public COPRAR.SegGrp3 withSEL(Collection<SELSealNumber> values) {
            if (values!= null) {
        ...
        public COPRAR.SegGrp3 withFTX(FTXFreeText... values) {
            if (values!= null) {
                for (FTXFreeText value: values) {
                    getFTX().add(value);
                }
        ...
        public COPRAR.SegGrp3 withFTX(Collection<FTXFreeText> values) {
            if (values!= null) {
                getFTX().addAll(values);
            }
            return this;
        ...
        public COPRAR.SegGrp3 withDGS(DGSDangerousGoods... values) {
            if (values!= null) {
        ...
        public COPRAR.SegGrp3 withDGS(Collection<DGSDangerousGoods> values) {
            if (values!= null) {
        ...
        public COPRAR.SegGrp3 withEQA(EQAAttachedEquipment... values) {
            if (values!= null) {
        ...
        public COPRAR.SegGrp3 withEQA(Collection<EQAAttachedEquipment> values) {
            if (values!= null) {
        ...
        public COPRAR.SegGrp3 withSegGrp4(COPRAR.SegGrp3 .SegGrp4 value) {
            setSegGrp4(value);
            return this;
        }

        public COPRAR.SegGrp3 withNAD(NADNameAndAddress value) {
            setNAD(value);
            return this;
        }
        ...
        public static class SegGrp4 {
            ...
            public COPRAR.SegGrp3 .SegGrp4 withTDT(TDTDetailsOfTransport value) {
                setTDT(value);
                return this;
            }

            public COPRAR.SegGrp3 .SegGrp4 withRFF(RFFReference... values) {
                if (values!= null) {
                    for (RFFReference value: values) {
                        getRFF().add(value);
                    }
            ...
            public COPRAR.SegGrp3 .SegGrp4 withRFF(Collection<RFFReference> values) {
                if (values!= null) {
                    getRFF().addAll(values);
                }
                return this;
            ...
            public COPRAR.SegGrp3 .SegGrp4 withLOC(LOCPlaceLocationIdentification... values) {
                if (values!= null) {
                    for (LOCPlaceLocationIdentification value: values) {
                        getLOC().add(value);
                    }
            ...
            public COPRAR.SegGrp3 .SegGrp4 withLOC(Collection<LOCPlaceLocationIdentification> values) {
                if (values!= null) {
                    getLOC().addAll(values);
                }
                return this;
            ...
            public COPRAR.SegGrp3 .SegGrp4 withDTM(DTMDateTimePeriod... values) {
                if (values!= null) {
                    for (DTMDateTimePeriod value: values) {
                        getDTM().add(value);
                    }
            ...
            public COPRAR.SegGrp3 .SegGrp4 withDTM(Collection<DTMDateTimePeriod> values) {
                if (values!= null) {
                    getDTM().addAll(values);
                }
                return this;
